...
example_foo <- function(AfrAA, NorAA, k)
{
  ...
  #grid()
  s <-c(30)
  s = (allF[,3]+allF[,4])/(allF[,6]+allF[,7])
  barplot(s, names.arg = allF[,2], horiz=TRUE,
          las = 1, main = "K", xlim = c(0, 30), col = c("aquamarine","blue") )
